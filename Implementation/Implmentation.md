...
### ADDED DOOFUS CHACRACTER

From Unity Asset store added a I took a character and have put and also added the rotation for the character as in the cube it is not required so added that bit of code in player Movement also now after this thinking of putting jump in as a additional character control to make the game more engaging 
